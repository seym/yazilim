  ...
  <div class="container">
    <div class="inside">
      ...
      <table width="542" border="3">
           ...
           <td width="10"></td>
               <td width="10"><form name="form1" method="post" action="">
                 <label for="textfield2"></label>
                 <input type="text" name="textfield12" id="textfield2">
               </form></td>
              </tr>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>
                  <input type="submit" name="button" id="button" value="Kaydet" onclick="parent.location='index.php'">
